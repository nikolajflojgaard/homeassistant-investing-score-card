...
test -f hacs.json
test -f custom_components/investing_score_card/manifest.json
test -f custom_components/investing_score_card/strings.json
test -f custom_components/investing_score_card/translations/en.json
test -f icon.png
test -f logo.png
...
manifest = json.loads(Path("custom_components/investing_score_card/manifest.json").read_text(encoding="utf-8"))
assert manifest.get("domain") == "investing_score_card", "manifest domain mismatch"
